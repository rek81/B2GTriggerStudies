# /users/algomez/B2GTriggers/V39 (CMSSW_9_2_1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/algomez/B2GTriggers/V39')
)
...
process.hltL1sHTT380 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_HTT300er" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreAK8PFJet360TrimMass30BtagCSVp087 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreAK8PFJet360TrimMass30BtagCSVp20 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreAK8PFJet380TrimMass30BtagCSVp087 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreAK8PFJet380TrimMass30BtagCSVp20 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreAK8PFJet400TrimMass30BtagCSVp087 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreAK8PFJet400TrimMass30BtagCSVp20 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.HLT_AK8DiPFJet280_200_TrimMass30_BTagCSV_p087_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet180IorSingleJet200 + process.hltPreAK8DiPFJet280200TrimMass30BTagCSVp087 + process.HLTAK8CaloJetsSequence + process.hltAK8SingleCaloJet260 + process.HLTAK4CaloJetsSequence + process.HLTBtagCSVSequenceL3 + process.hltBTagCaloCSVp087Single + process.HLTAK8PFJetsSequence + process.hltAK8PFJetsCorrectedMatchedToCaloJets260 + process.hltAK8TrimModJets + process.hltAK8DiPFJet200TrimMod + process.hltAK8SinglePFJet280TrimMod + process.hltAK8PFJet200TrimModMass30 + process.HLTEndSequence )
process.HLT_AK8DiPFJet300_200_TrimMass30_BTagCSV_p20_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet180IorSingleJet200 + process.hltPreAK8DiPFJet300200TrimMass30BTagCSVp20 + process.HLTAK8CaloJetsSequence + process.hltAK8SingleCaloJet280 + process.HLTAK4CaloJetsSequence + process.HLTBtagCSVSequenceL3 + process.hltBTagCaloCSVp20Single + process.HLTAK8PFJetsSequence + process.hltAK8PFJetsCorrectedMatchedToCaloJets280 + process.hltAK8TrimModJets + process.hltAK8DiPFJet200TrimMod + process.hltAK8SinglePFJet300TrimMod + process.hltAK8PFJet200TrimModMass30 + process.HLTEndSequence )
process.HLT_AK8PFHT800_TrimMass50_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sHTT380 + process.hltPreAK8PFHT800TrimMass50 + process.HLTAK8CaloJetsSequence + process.hltAK8HtMht + process.hltAK8Ht700 + process.HLTAK8PFJetsSequence + process.hltAK8PFHTwJetPt200 + process.hltAK8TrimModJets + process.hlt1AK8PFJetsTrimMass50Pt200 + process.hltAK8PFHT800 + process.HLTEndSequence )
process.HLT_AK8PFHT850_TrimMass50_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sHTT380 + process.hltPreAK8PFHT850TrimMass50 + process.HLTAK8CaloJetsSequence + process.hltAK8HtMht + process.hltAK8Ht750 + process.HLTAK8PFJetsSequence + process.hltAK8PFHTwJetPt200 + process.hltAK8TrimModJets + process.hlt1AK8PFJetsTrimMass50Pt200 + process.hltAK8PFHT850 + process.HLTEndSequence )
process.HLT_AK8PFHT900_TrimMass50_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sHTT380 + process.hltPreAK8PFHT900TrimMass50 + process.HLTAK8CaloJetsSequence + process.hltAK8HtMht + process.hltAK8Ht800 + process.HLTAK8PFJetsSequence + process.hltAK8PFHTwJetPt200 + process.hltAK8TrimModJets + process.hlt1AK8PFJetsTrimMass50Pt200 + process.hltAK8PFHT900 + process.HLTEndSequence )
process.HLT_AK8PFJet360_TrimMass30_BtagCSV_p087_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet180 + process.hltPreAK8PFJet360TrimMass30BtagCSVp087 + process.HLTAK8CaloJetsSequence + process.hltAK8SingleCaloJet260 + process.HLTAK4CaloJetsSequence + process.HLTBtagCSVSequenceL3 + process.hltBTagCaloCSVp087Single + process.HLTAK8PFJetsSequence + process.hltAK8PFJetsCorrectedMatchedToCaloJets260 + process.hltAK8TrimModJets + process.hltAK8SinglePFJet360TrimModMass30 + process.HLTEndSequence )
process.HLT_AK8PFJet360_TrimMass30_BtagCSV_p20_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet180 + process.hltPreAK8PFJet360TrimMass30BtagCSVp20 + process.HLTAK8CaloJetsSequence + process.hltAK8SingleCaloJet260 + process.HLTAK4CaloJetsSequence + process.HLTBtagCSVSequenceL3 + process.hltBTagCaloCSVp20Single + process.HLTAK8PFJetsSequence + process.hltAK8PFJetsCorrectedMatchedToCaloJets260 + process.hltAK8TrimModJets + process.hltAK8SinglePFJet360TrimModMass30 + process.HLTEndSequence )
process.HLT_AK8PFJet380_TrimMass30_BtagCSV_p087_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet180 + process.hltPreAK8PFJet380TrimMass30BtagCSVp087 + process.HLTAK8CaloJetsSequence + process.hltAK8SingleCaloJet280 + process.HLTAK4CaloJetsSequence + process.HLTBtagCSVSequenceL3 + process.hltBTagCaloCSVp087Single + process.HLTAK8PFJetsSequence + process.hltAK8PFJetsCorrectedMatchedToCaloJets280 + process.hltAK8TrimModJets + process.hltAK8SinglePFJet380TrimModMass30 + process.HLTEndSequence )
process.HLT_AK8PFJet380_TrimMass30_BtagCSV_p20_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet180 + process.hltPreAK8PFJet380TrimMass30BtagCSVp20 + process.HLTAK8CaloJetsSequence + process.hltAK8SingleCaloJet280 + process.HLTAK4CaloJetsSequence + process.HLTBtagCSVSequenceL3 + process.hltBTagCaloCSVp20Single + process.HLTAK8PFJetsSequence + process.hltAK8PFJetsCorrectedMatchedToCaloJets280 + process.hltAK8TrimModJets + process.hltAK8SinglePFJet380TrimModMass30 + process.HLTEndSequence )
...
process.HLT_AK8PFJet400_TrimMass30_BtagCSV_p087_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet180 + process.hltPreAK8PFJet400TrimMass30BtagCSVp087 + process.HLTAK8CaloJetsSequence + process.hltAK8SingleCaloJet300 + process.HLTAK4CaloJetsSequence + process.HLTBtagCSVSequenceL3 + process.hltBTagCaloCSVp087Single + process.HLTAK8PFJetsSequence + process.hltAK8PFJetsCorrectedMatchedToCaloJets300 + process.hltAK8TrimModJets + process.hltAK8SinglePFJet400TrimModMass30 + process.HLTEndSequence )
process.HLT_AK8PFJet400_TrimMass30_BtagCSV_p20_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet180 + process.hltPreAK8PFJet400TrimMass30BtagCSVp20 + process.HLTAK8CaloJetsSequence + process.hltAK8SingleCaloJet300 + process.HLTAK4CaloJetsSequence + process.HLTBtagCSVSequenceL3 + process.hltBTagCaloCSVp20Single + process.HLTAK8PFJetsSequence + process.hltAK8PFJetsCorrectedMatchedToCaloJets300 + process.hltAK8TrimModJets + process.hltAK8SinglePFJet400TrimModMass30 + process.HLTEndSequence )
process.HLT_AK8PFJet400_TrimMass30_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet180 + process.hltPreAK8PFJet400TrimMass30 + process.HLTAK8CaloJetsSequence + process.hltAK8SingleCaloJet300 + process.HLTAK8PFJetsSequence + process.hltAK8PFJetsCorrectedMatchedToCaloJets300 + process.hltAK8TrimModJets + process.hltAK8SinglePFJet400TrimModMass30 + process.HLTEndSequence )
process.HLT_AK8PFJet420_TrimMass30_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet180 + process.hltPreAK8PFJet420TrimMass30 + process.HLTAK8CaloJetsSequence + process.hltAK8SingleCaloJet320 + process.HLTAK8PFJetsSequence + process.hltAK8PFJetsCorrectedMatchedToCaloJets320 + process.hltAK8TrimModJets + process.hltAK8SinglePFJet420TrimModMass30 + process.HLTEndSequence )
...
process.HLT_AK8PFJet500_v5 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet170IorSingleJet180IorSingleJet200 + process.hltPreAK8PFJet500 + process.HLTAK8CaloJetsSequence + process.hltSingleCaloJet450AK8 + process.HLTAK8PFJetsSequence + process.hltPFJetsCorrectedMatchedToCaloJets450AK8 + process.hltSinglePFJet500AK8 + process.HLTEndSequence )


process.HLTSchedule = cms.Schedule( *(process.HLT_AK8DiPFJet280_200_TrimMass30_BTagCSV_p087_v1, process.HLT_AK8DiPFJet300_200_TrimMass30_BTagCSV_p20_v1, process.HLT_AK8PFHT800_TrimMass50_v1, process.HLT_AK8PFHT850_TrimMass50_v1, process.HLT_AK8PFHT900_TrimMass50_v1, process.HLT_AK8PFJet360_TrimMass30_BtagCSV_p087_v1, process.HLT_AK8PFJet360_TrimMass30_BtagCSV_p20_v1, process.HLT_AK8PFJet380_TrimMass30_BtagCSV_p087_v1, process.HLT_AK8PFJet380_TrimMass30_BtagCSV_p20_v1, process.HLT_AK8PFJet380_TrimMass30_v1, process.HLT_AK8PFJet400_TrimMass30_BtagCSV_p087_v1, process.HLT_AK8PFJet400_TrimMass30_BtagCSV_p20_v1, process.HLT_AK8PFJet400_TrimMass30_v1, process.HLT_AK8PFJet420_TrimMass30_v1, process.HLT_PFHT1050_v7, process.HLT_AK8PFJet500_v5 ))
...
process.AK8PFJet400_filter = hlt.triggerResultsFilter.clone(
		triggerConditions = cms.vstring( 'HLT_AK8PFJet500*', 'HLT_PFHT1050*', 'HLT_AK8PFJet400_TrimMass30_v1' ),
		l1tResults = '',
		throw = False
		)
...
process.Subtructure_filter = hlt.triggerResultsFilter.clone(
		triggerConditions = cms.vstring( 'HLT_AK8PFJet500*', 'HLT_PFHT1050*', 'HLT_AK8PFJet400_TrimMass30_v1', 'HLT_AK8PFHT850_TrimMass50_v1' ),
		l1tResults = '',
		throw = False
		)
...
process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/0E3A711F-5345-E711-9405-02163E0127E2.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/1E7BFCF5-4F45-E711-BF0F-02163E013750.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/1ED00793-5C45-E711-8279-02163E014197.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/28BE0A88-5D45-E711-B5DB-02163E019C20.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/2C8D876C-5645-E711-BF70-02163E01A294.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/3A481595-5945-E711-80C8-02163E01A628.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/3CAC1D1A-5C45-E711-A3D6-02163E014285.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/3E65345A-4F45-E711-A0E2-02163E019E78.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/46C21428-5A45-E711-89C9-02163E01471D.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/4A399E9E-5245-E711-84ED-02163E013468.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/4CD1C1C4-6445-E711-B71C-02163E01A6F8.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/502B2015-6245-E711-9E00-02163E0146B5.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/5C454785-4F45-E711-A523-02163E01A5F4.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/66595C59-5245-E711-B8ED-02163E01A2CC.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/7A14FFD5-5945-E711-9C1D-02163E011B96.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/96DA9FA4-5345-E711-BD49-02163E013809.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/9A701CC9-4F45-E711-ABD8-02163E019C4E.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/A624994B-5445-E711-B400-02163E0140DA.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/A8748C83-4F45-E711-93C5-02163E01A264.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/AE49558A-4F45-E711-9789-02163E01383D.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/BA18EB29-0C46-E711-970D-02163E01383B.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/BEBD1A4C-5D45-E711-B011-02163E0141C3.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/C24EDA55-4F45-E711-B92A-02163E01A5C0.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/C4ECC9A2-4F45-E711-A6FA-02163E0145EF.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/CE17951C-6245-E711-BD1D-02163E01A302.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/D0EA0CDB-4C45-E711-8559-02163E019B31.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/D49878CF-5D45-E711-9B75-02163E01A342.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/D6E93094-6045-E711-93B2-02163E01442D.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/EE671F3F-5445-E711-BE3F-02163E011952.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/EE80E679-5C45-E711-B2D1-02163E0138E9.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/F2DC29AC-4F45-E711-94D1-02163E0122C7.root',
		'/store/data/Run2017A/HLTPhysics/RAW/v1/000/295/613/00000/F671CDBF-4F45-E711-BEC7-02163E01A72E.root',
    ),
...
_customInfo['globalTag' ]= "92X_dataRun2_HLT_v2"
