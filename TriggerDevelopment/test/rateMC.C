...
//
using namespace std;
Int_t    VERBOSE = 3; // full verbosity = 3
...
Int_t rateMC(UInt_t minPU=54, UInt_t maxPU=58, Double_t lumi=2.0e34, TString input="All")
{
...
Int_t DefinePaths(vector<TString> &paths)
{
  ...
  paths.push_back("HLT_AK8PFHT750_TrimMass50_v2"); 
  paths.push_back("HLT_AK8PFHT750_SDMass50_v1"); 
  paths.push_back("HLT_AK8PFHT750_SDMass40_v1"); 
  paths.push_back("HLT_AK8PFHT750_SDMass30_v1"); 
  paths.push_back("HLT_AK8PFHT750_SDMass20_v1"); 
  paths.push_back("HLT_AK8PFHT750_SDMass10_v1"); 
  paths.push_back("HLT_AK8PFHT800_TrimMass50_v2"); 
  paths.push_back("HLT_AK8PFHT800_SDMass40_v1"); 
  paths.push_back("HLT_AK8PFHT800_SDMass50_v1"); 
  paths.push_back("HLT_AK8PFHT800_SDMass30_v1"); 
  paths.push_back("HLT_AK8PFHT800_SDMass20_v1"); 
  paths.push_back("HLT_AK8PFHT800_SDMass10_v1"); 
  paths.push_back("HLT_AK8PFHT850_TrimMass50_v1"); 
  paths.push_back("HLT_AK8PFHT850_SDMass50_v1"); 
  paths.push_back("HLT_AK8PFHT850_SDMass40_v1"); 
  paths.push_back("HLT_AK8PFHT850_SDMass30_v1"); 
  paths.push_back("HLT_AK8PFHT850_SDMass20_v1"); 
  paths.push_back("HLT_AK8PFHT850_SDMass10_v1"); 
  paths.push_back("HLT_AK8PFHT900_TrimMass50_v1"); 
  paths.push_back("HLT_AK8PFJet340_SDMass10_v1"); 
  paths.push_back("HLT_AK8PFJet340_SDMass20_v1"); 
  paths.push_back("HLT_AK8PFJet340_SDMass30_v1"); 
  paths.push_back("HLT_AK8PFJet340_SDMass40_v1"); 
  paths.push_back("HLT_AK8PFJet340_SDMass50_v1"); 
  paths.push_back("HLT_AK8PFJet360_SDMass10_v1"); 
  paths.push_back("HLT_AK8PFJet360_SDMass20_v1"); 
  paths.push_back("HLT_AK8PFJet360_SDMass30_v1"); 
  ...
  paths.push_back("HLT_AK8PFJet380_SDMass40_v1"); 
  paths.push_back("HLT_AK8PFJet380_SDMass50_v1"); 
  paths.push_back("HLT_AK8PFJet380_TrimMass30_v1"); 
  paths.push_back("HLT_AK8PFJet400_SDMass10_v1"); 
  paths.push_back("HLT_AK8PFJet400_SDMass20_v1"); 
...
Int_t DefineChains(vector<TString> &processes, vector<TChain*> &chains)
{
  ...
  TString pathEOS="/afs/cern.ch/work/a/algomez/triggerStudies/CMSSW_9_2_3_patch1/src/B2GTriggerStudies/TriggerDevelopment/test/Rootfiles/";
